					...
					<form action="${pageContext.request.contextPath}/ProductServlet/insert" method="post">
						<table class="entry__table">
							...
							<tr>
								...
								<td class="table__value">
									<input type="text" name="name" placeholder="商品名" value="" />
								</td>
							</tr>
							<tr>
								<th class="table__label">価格</th>
								<td class="table__value">
									<input type="number" name="price" placeholder="価格" value="" />
								</td>
							</tr>
							<tr>
								<th class="table__label">数量</th>
								<td class="table__value">
									<input type="number" name="quantity" placeholder="数量" value="" />
								</td>
							</tr>
							<tr>
								<td colspan="2" class="table__value">
